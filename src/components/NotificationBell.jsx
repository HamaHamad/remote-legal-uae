...
import { Bell, Check, CheckCheck, Brain, CreditCard, Briefcase, FileText, AlertCircle, Shield } from 'lucide-react'
              ...
              <div>
                {notifications.map(notif => {
                  ...
                  return (
                    ...
                    >
                      <div className={clsx('w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5', cfg.bg)}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {notif.body && (
                          <p className="text-[11px] text-[var(--text-muted)] mt-0.5 line-clamp-2">{notif.body}</p>
                        )}
