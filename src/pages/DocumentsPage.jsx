...
function FileChip({ mimeType, fileName }) {
  ...
  if (isDoc)
    return (
      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold bg-indigo-500/15 text-indigo-400">
        DOC
      </span>
    )
  return (
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--text-secondary)]">
              ...
              <span className="font-medium text-[var(--text-primary)]">"{doc.file_name}"</span>?
